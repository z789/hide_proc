...
#ifndef _HIDE_PROC_CRYPTO_AES_H
#define _HIDE_PROC_CRYPTO_AES_H
...
void aes_encrypt_ctr(char *src, int len, const char *in_key, int klen);
#define aes_decrypt_ctr(src, len, in_key, klen) aes_encrypt_ctr(src, len, in_key, klen)
